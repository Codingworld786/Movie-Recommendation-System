...
Used TMDB dataset from Kaggle and fetched the poster of the movies using API key. link to dataset: https://www.kaggle.com/datasets/tmdb/tmdb-movie-metadata?select=tmdb_5000_movies.csv
